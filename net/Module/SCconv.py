...
class SCConv3D(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride = 1,
        ...
        group_width = int(planes * (0.5)) * cardinality
        ...
        self.sc = Self_Cailbration(
            ...
            padding=dilation, dilation=dilation,
            groups=cardinality, pooling_r=self.pooling_r, norm_layer=norm_layer,Dynamic_ker_size=False)
...
class MSCConv3D(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride = 1,
        ...
        self.sc2 = Self_Cailbration(
            ...
            groups=cardinality, pooling_r=self.pooling_r[0],norm_layer=norm_layer,Dynamic_ker_size=True)
        self.sc4 = Self_Cailbration(
            group_width, group_width, stride=stride,
            padding="same", dilation=dilation,
            groups=cardinality, pooling_r=self.pooling_r[1],norm_layer=norm_layer,Dynamic_ker_size=True)
        self.sc8 = Self_Cailbration(
            group_width, group_width, stride=stride,
            padding="same", dilation=dilation,
            groups=cardinality, pooling_r=self.pooling_r[2],norm_layer=norm_layer,Dynamic_ker_size=True)
        self.conv3 = nn.Conv3d(
