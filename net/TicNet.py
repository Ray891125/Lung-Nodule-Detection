...
from .Module.Atten_Conv import*
from .Module.multi_scale import conv_3nV1, conv_2nV1
bn_momentum = 0.1
affine = True
...
class TicNet(nn.Module):
    def __init__(self, cfg, mode='train'):
        super(TicNet, self).__init__()

        self.cfg = cfg
        self.mode = mode
        self.feature_net = FeatureNet(in_channels=1, out_channels=128)
